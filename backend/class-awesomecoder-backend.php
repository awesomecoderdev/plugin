...
namespace AwesomeCoder\Plugin\Starter\Backend;
...
class Awesomecoder_Backend
{
	...
	public function enqueue_styles($hook)
	{
		...
		if (in_array($hook, $this->pages)) {
			...
			wp_enqueue_style("{$this->plugin_name}", AWESOMECODER_URL . 'backend/css/awesomecoder-backend.css', array(), (filemtime(AWESOMECODER_PATH . "backend/css/awesomecoder-backend.css") ?? $this->version), 'all');
		}
